...
const AdminEventPage = () => {
  ...
  const addEvent = (e) => {
    ...
    setEventDescription('');
    setEventOrganizer('');
    setEventPoster(null); // Clear the image preview
  ...
  const handleImageUpload = (e) => {
    ...
    if (file) {
      ...
      setEventPoster(imageUrl); // Store the image URL for preview
    }
  };
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <form onSubmit={addEvent}>
              ...
              {/* Event Organizer */}
              <div className="mb-4">
                <label htmlFor="eventOrganizer" className="block text-sm font-medium text-gray-700">Organizer</label>
                <input
                  type="text"
                  id="eventOrganizer"
              ...
              {/* Event Poster Image */}
              <div className="mb-4">
                <label htmlFor="eventPoster" className="block text-sm font-medium text-gray-700">Event Poster Image</label>
                <input
                  type="file"
                  id="eventPoster"
                  ref={fileInputRef}
                ...
                {eventPoster && (
                  <div className="mt-4">
                    <img src={eventPoster} alt="Event Poster" className="w-32 h-32 object-cover rounded-md" />
                  </div>
                )}
              </div>
